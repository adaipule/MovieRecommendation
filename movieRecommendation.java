  ...
  public void map(LongWritable key, Text value, OutputCollector<Text, Text> output, Reporter reporter) throws IOException {
	...
	if(!(line.isEmpty()))
	{
	  //movie ratings are in the form "userID,movieID,rating,date"
          ...
          output.collect(word, new Text(movieidAndrating));
...
public static void main(String[] args) throws Exception {
		int i;
		JobConf conf1 = new JobConf(movieRecommendation.class);
		...
		JobConf conf2 = new JobConf(movieRecommendation.class);
		...
		JobConf conf3 = new JobConf(movieRecommendation.class);
		...
		JobConf conf4 = new JobConf(movieRecommendation.class);
